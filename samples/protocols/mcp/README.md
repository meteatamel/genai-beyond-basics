...
[Model Context Protocol](https://modelcontextprotocol.io/) (MCP) is an open protocol, from Anthropic, that standardizes how models and agents access external tools and resources.
