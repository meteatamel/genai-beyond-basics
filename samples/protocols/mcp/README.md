...
[Model Context Protocol](https://modelcontextprotocol.io/) (MCP) is an open protocol, originally from Anthropic, that standardizes how models and agents access external tools and resources.
